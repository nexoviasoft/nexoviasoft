...
const Intregration = () => {
    ...
    const integrationIcons = [
        { icon: Video, color: "bg-blue-900", iconColor: "text-blue-400" }, // Zoom-ish
        ...
        { icon: GitBranch, color: "bg-blue-500", iconColor: "text-white" }, // Bitbucket-ish
        { icon: Check, color: "bg-indigo-600", iconColor: "text-white", isMain: true }, // Main Active
    ...
    return (
        <section className="bg-black py-24 px-4 overflow-hidden relative">
            {/* Background Glows */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-purple-900/20 rounded-full blur-[120px]" />
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                <motion.div
                    ...
                    className="mb-20"
                >
                    <button className="bg-[#5B21B6] hover:bg-[#4C1D95] text-white px-8 py-3 rounded-full font-medium transition-colors shadow-[0_0_20px_rgba(91,33,182,0.5)]">
                        View About Reboot
                    </button>
                </motion.div>
                    ...
                    {integrationIcons.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {isMain && (
                                    <div className="absolute inset-0 rounded-full border-4 border-indigo-400/30 animate-pulse" />
                                )}

                                <Icon className={`${isMain ? "w-8 h-8" : "w-6 h-6"} ${item.iconColor}`} />
                            </motion.div>
                        );
                    })}
                </motion.div>

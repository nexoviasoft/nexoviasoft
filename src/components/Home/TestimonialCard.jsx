...
const TestimonialCard = ({ name, role, company, image, text, rating, delay }) => {
    return (
        <motion.div
            ...
            className="bg-[#111] border border-white/5 rounded-2xl p-8 relative group hover:border-[#8B5CF6]/20 transition-colors duration-300"
        >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                    <div className="flex justify-between items-start mb-6">
                        <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#8B5CF6]/20 p-0.5">
                            <img
                                src={image}
                                alt={name}
                ...
                <div>
                    <h4 className="text-white font-medium text-base">
                        {name} <span className="text-[#8B5CF6] mx-1">•</span>{" "}

            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-20">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center px-4 py-1.5 rounded-full border border-[#8B5CF6]/30 bg-[#8B5CF6]/10 mb-8"
                    >
                        ...
                        <span className="text-gray-300 text-sm font-medium">Comparison</span>
                    </motion.div>
